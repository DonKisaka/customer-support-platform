    ...
    public AgentCard agentCard(
        ...
        return new AgentCard.Builder()
                ...
                .skills(List.of(new AgentSkill.Builder()
                        .id("escalation_support")
                        .name("Escalation Support Agent")
                        .description("Handles complex issues requiring human-in-the-loop confirmation")
                        .tags(List.of("escalation", "human-in-the-loop", "tickets", "support"))
                        .build()))
